...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { information: @tour.information, name: @tour.name, number_of_member: @tour.number_of_member }
    end
  ...
  test "should update tour" do
    patch :update, id: @tour, tour: { information: @tour.information, name: @tour.name, number_of_member: @tour.number_of_member }
    assert_redirected_to tour_path(assigns(:tour))
  end
